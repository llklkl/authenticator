...
class AuthenticatorImpl implements Authenticator {
  final AuthenticatorPlatform _platform;
  factory AuthenticatorImpl(ExternalLibrary dylib) =>
      AuthenticatorImpl.raw(AuthenticatorPlatform(dylib));
...
class AuthenticatorPlatform extends FlutterRustBridgeBase<AuthenticatorWire> {
  AuthenticatorPlatform(ffi.DynamicLibrary dylib)
      : super(AuthenticatorWire(dylib));
...
class AuthenticatorWire implements FlutterRustBridgeWireBase {
  @internal
  ...
  AuthenticatorWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  AuthenticatorWire.fromLookup(
