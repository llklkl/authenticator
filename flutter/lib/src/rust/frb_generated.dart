...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 235503943;

  static const kDefaultExternalLibraryLoaderConfig =
      ExternalLibraryLoaderConfig(
    stem: 'rust_lib_authenticator',
...
abstract class RustLibApi extends BaseApi {
  String crateApiApiAppinfo({required String name});

  void crateApiApiInit({required String dataPath});
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  String crateApiApiAppinfo({required String name}) {
    return handler.executeSync(SyncTask(
      ...
      constMeta: kCrateApiApiAppinfoConstMeta,
      argValues: [name],
      apiImpl: this,
    ));
  }

  TaskConstMeta get kCrateApiApiAppinfoConstMeta => const TaskConstMeta(
        debugName: "appinfo",
        argNames: ["name"],
      );
